...
compile_error!("you must enable either `three_d` or `wgpu` feature to run this code");
fn main() {
    ...
    egui_overlay::start(HelloWorld { frame: 0, passthrough_enabled: true });
}
const ICON_BYTES: &[u8] = include_bytes!("test_icon.png");
...
impl EguiOverlay for HelloWorld {
    fn gui_run(
        ...
        egui::Window::new("controls").show(egui_context, |ui| {
            ...
            ui.checkbox(&mut self.passthrough_enabled, "passthrough");
        });
        ...
        if egui_context.wants_pointer_input() || egui_context.wants_keyboard_input() {
            ...
            glfw_backend.set_passthrough(self.passthrough_enabled)
        }
